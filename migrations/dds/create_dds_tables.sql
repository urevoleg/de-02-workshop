...
CREATE TABLE IF NOT EXISTS dds.d_utm_campaign (
	...
	utm_campaign_name varchar,
	utm_source varchar,
	utm_content varchar,
	UNIQUE (utm_campaign_name, utm_source, utm_content)
);
